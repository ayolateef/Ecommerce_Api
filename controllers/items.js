...
exports.getItems = asyncHandler(async (req, res, next) => {
    ...
    const items = await Item.find({}).populate({path: 'category', select: 'name description'}).sort('items');
...
exports.getItem = asyncHandler(async(req, res, next) => {
    const item = await Item.findById(req.params.id).populate({path: 'category', select: 'name'}).sort('items');
